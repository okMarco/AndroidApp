...
import static com.hochan.tumlodr.module.glide.TumlodrGlideModule.expect;
import static com.hochan.tumlodr.module.glide.TumlodrGlideModule.forget;

public abstract class ProgressTarget<T, Z> extends WrappingTarget<Z> implements TumlodrGlideModule.UIProgressListener {
	...
	public final void setModel(T model) {
		TumlodrGlide.with(TumlodrApp.mContext).clear(this);
		this.model = model;
	}
	 ...
	 */
	protected abstract void onDownloaded(long totalLength);
